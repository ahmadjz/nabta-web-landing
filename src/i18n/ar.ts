      ...
      shots: [
        {
          ...
          body: "تصفّح تشكيلة نباتات الزينة بأسعار واضحة بالليرة السورية، وابحث بالاسم المحلي أو العلمي أو الإنجليزي.",
        },
        {
          alt: "لقطة شاشة توضيحية: المساعد الذكي لاختيار النبات",
          caption: "المساعد الذكي",
          body: "أجب عن أسئلة بسيطة حول المساحة والإضاءة وحاجة الريّ ومستوى خبرتك، فيقترح عليك التطبيق قائمة نباتات تناسبك.",
        },
        {
